...
quadrilateral_pts = np.array([[508, 832], [608, 908], [1287, 831], [1132, 790]], np.int32)
...
while True:
    if not pause:
        ...
        # Draw the quadrilateral on each frame
        cv2.polylines(im0, [quadrilateral_pts], isClosed=True, color=(255, 255, 255), thickness=2)
